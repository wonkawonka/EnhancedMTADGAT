...
class Solver(object):
    ...
    def test(self):
        ...
        if output_dir:
            save_standardized_output(
                    ...
                    thresholds={
                        ...
                        "anormly_ratio": getattr(self, 'anormly_ratio', 4.0),
                    },
        ...
        if self.data_path in ('UCR', 'UCR_AUG'):
            import csv
            if output_dir:
                result_csv_path = os.path.join(output_dir, 'native_results', f'{self.data_path}.csv')
                os.makedirs(os.path.dirname(result_csv_path), exist_ok=True)
            else:
                result_csv_path = 'result/' + self.data_path + '.csv'
